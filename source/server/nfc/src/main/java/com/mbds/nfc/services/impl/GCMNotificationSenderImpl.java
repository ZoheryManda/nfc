...
//    private final DeviceDAO deviceDAO;
    ...
    @Autowired
    public GCMNotificationSenderImpl(Sender gcmSender) {
...
//        }
        ...
        final List<String> validDeviceIds = Arrays.asList(notification.getRegistrationIdsToSend());
...
//        final List<Utilisateur> utilisateurs = utilisateurSevice.findAll();
